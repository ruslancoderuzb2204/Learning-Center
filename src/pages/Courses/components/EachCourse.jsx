...
const EachCourse = ({
  ...
  return (
    <div
      data-aos="fade-down"
      className="bg-white p-10 xl:p-8 lg:p-6 md:p-4 sm:p-2 rounded-lg mb-10 lg:mb-8 md:mb-5 sm:mb-3"
    >
      <Header title={title} text={text} id={id} />
      <div data-aos="fade-down" className="grid gap-6 xs:gap-2 grid-cols-3">
        <div>
      ...
      <div
        ...
        className="flex justify-between items-center py-6 lg:py-4 md:py-2 text-lg lg:text-base md:text-sm"
      >
      ...
      <div className="border rounded-md p-4 text-xl font-semibold">
        ...
        <div
          data-aos="fade-up"
          data-aos-anchor-placement="bottom-bottom"
          className="flex justify-between  sm:hidden xs:flex xs:flex-col xs:gap-0 gap-4"
        >
