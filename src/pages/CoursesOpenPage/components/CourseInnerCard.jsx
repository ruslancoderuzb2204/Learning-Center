  ...
  return (
    <>
      <div
        ...
        className=" items-center flex     justify-between  p-6 lg:p-3 md:p-2 sm:p-6 xs:p-4 border rounded-lg my-5 lg:my-4 md:my-2"
      >
        <div className="w-2/3 ">
      ...
      <div
        ...
        data-aos-easing="ease-out-cubic"
        data-aos-duration="1000"
        className=" items-center flex    justify-between  p-6 lg:p-4 md:p-2 sm:p-6 xs:p-4 border rounded-md my-5 lg:my-4 md:my-2"
      >
        <div className="w-2/3 ">
      ...
      <div
        ...
        data-aos-easing="ease-out-cubic"
        data-aos-duration="1000"
        className="flex    justify-between  items-center  p-6 lg:p-4 md:p-2 sm:p-6 xs:p-4 border rounded-md my-5 lg:my-4 md:my-2"
      >
        <div className="w-2/3 ">
          <h2 className="text-xl font-semibold lg:text-lg md:text-base">
