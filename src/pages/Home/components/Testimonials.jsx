...
const Testimonials = () => {
  const data = [
    {
      img: "http://localhost:5173/src/pages/home/constants/img1.png",
    ...
    {
      img: "http://localhost:5173/src/pages/home/constants/img2.png",
    ...
    {
      img: "http://localhost:5173/src/pages/home/constants/img3.png",
    ...
    {
      img: "http://localhost:5173/src/pages/home/constants/img4.png",
